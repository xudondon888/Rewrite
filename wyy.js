...
# 播放器会员歌曲
^https:\/\/interface3?\.music\.163\.com\/eapi\/v3\/song\/detail url script-request-header cloudmusic.js
^https:\/\/interface3?\.music\.163\.com\/eapi\/song\/(chorus|enhance\/|play\/|type\/detail\/get) url script-request-header cloudmusic.js
...
headers['User-Agent'] = 'NeteaseMusic 8.20.02/4554 (iPhone; iOS 17.0.1; zh_CN)';

headers['MConfig-Info'] = '{"2"}}';
